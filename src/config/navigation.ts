...
const primaryNavItems: ReadonlyArray<INavigationItem> = [
	...
	},
	{
		...
		trackingId: createTrackingId("nav_progress_hub"),
		ariaLabel:
			"Access your progress hub with assessments, streaks, and leaderboard",
		description:
			"Track your learning progress, view assessments, streaks, and compete on the leaderboard",
		hotkey: "p",
	},
	{
	...
	{
		id: createNavigationId("nav-mentors"),
		title: "Mentors",
		hrefOrExternalUrl: "/mentors",
		icon: "robot" as const,
		order: 5,
		section: "primary" as const,
		roles: ["authenticated"] as const,
		trackingId: createTrackingId("nav_mentors"),
