...
import History from "@/modules/mentor/components/history";
...
import { historyItems as initialHistoryItems } from "@/modules/mentor/components/history"; // Import historyItems as initialHistoryItems

const HistoryPage = () => {
  const [searchTerm, setSearchTerm] = useState("");
  const [isSelectionMode, setIsSelectionMode] = useState(false);
  const [selectedItems, setSelectedItems] = useState<string[]>([]); // Store titles of selected items
  const [currentHistoryItems, setCurrentHistoryItems] = useState(initialHistoryItems);
